...
* O sistema [Calibração acelerômetro **MPU 6050**](../Acelerometro-Angulo "Teste de Calibração e utilização **MPU6050** Arduino IDE") deve ser utilizado para testa a calibração.
